...
function App() {
  ...
  const phrases = {
    ua: {
        ...
        studentRequirments: {
          title: 'Вимоги для студентів',
          ul_1: '18+.',
          ul_2: 'Українці, постраждалі від війни.',
          ul_3: 'Немає ресурсів, щоб отримати ІТ освіту чи піти на курси.'
        },
        contributors: {
    ...
    en: {
        ...
        studentRequirments: {
          ...
          ul_1: '18+.',
          ul_2: 'Ukrainians impacted by the war.',
          ul_3: 'No money to pay for the same service.'
        },
        contributors: {
            title: 'Contribute',
